...
const partners = [
	{
		...
		desc: (
			<p>
				"SMIT.studio - эксперты в интерактивом маркетинге <br />{" "}
				Наращивайте своё сообщество лояльными игроками, которых в
				будущем конвертируете в адвокатов бренда"
			</p>
		),
	...
	},
	{
		...
		name: "Smit.Screen",
		desc:
			"Проект, открывающий для бизнеса новые возможности в мире наружной рекламы",
