  ...
  render() {
    ...
    return (
      <div style={{ height: "100%", width: "100%" }}>
        {!loading && !errorUserPermissions && <VipAssistent user={user} />}
...
export default compose(withApiService(), connect(mapStateToProps, mapDispatchToProps))(VipAssistentContainer);
