...
i18n.use(LanguageDetector).init({
  ...
  resources: {
    ...
    //     "Инновационный партнер": "Инновационный партнер",
    //     "Премиум партнер": "Премиум партнер",
    ...
    en: {
      translations: {
        ...
        "Инновационный партнер": "Innovative partner",
        "Премиум партнер": "Premium partner",
        ...
        "Дополнительные материалы": "Attachments",
    ...
    ua: {
      translations: {
        ...
        "Инновационный партнер": "Інноваційний партнер",
        "Премиум партнер": "Преміум партнер",

        Сообщения: "Чати",
        "Перейдите в нетворкинг и выберите человека, чтобы начать с ним общаться":
          "Долучитися до нетворкінгу та обрати людину, з якою бажаєте спілкуватися",
        'У вас новое сообщение!': 'У вас новое сообщение!',

        "Связь с организаторами": `Зв’язатися <br /> з організаторами`,

        Переговорки: "Кімнати",
        "Открытые комнаты": "Відкриті кімнати",
        человек: "человек",
        ...
        "Опросы": 'Опросы',
        "Введите ваше сообщение": "Введіть Ваше повідомлення",
